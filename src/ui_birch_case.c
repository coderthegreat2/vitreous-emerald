...
{
    [BALL_TOP_FIRST]        = {SPECIES_MUDKIP, 5, ITEM_ORAN_BERRY, BALL_POKE, NATURE_DOCILE, 1, MON_GENDERLESS, {0, 0, 0, 0, 0, 0}, {31, 31, 31, 31, 31, 31}},
    [BALL_TOP_SECOND]       = {SPECIES_TREECKO, 5, ITEM_ORAN_BERRY, BALL_POKE, NATURE_DOCILE, 1, MON_GENDERLESS, {0, 0, 0, 0, 0, 0}, {31, 31, 31, 31, 31, 31}},
    [BALL_MIDDLE_FIRST]     = {SPECIES_TORCHIC, 5, ITEM_ORAN_BERRY, BALL_POKE, NATURE_DOCILE, 1, MON_GENDERLESS, {0, 0, 0, 0, 0, 0}, {31, 31, 31, 31, 31, 31}},

    [BALL_TOP_THIRD]        = {SPECIES_CHIKORITA, 5, ITEM_ORAN_BERRY, BALL_POKE, NATURE_DOCILE, 1, MON_GENDERLESS, {0, 0, 0, 0, 0, 0}, {31, 31, 31, 31, 31, 31}},
    [BALL_TOP_FOURTH]       = {SPECIES_TOTODILE, 5, ITEM_ORAN_BERRY, BALL_POKE, NATURE_DOCILE, 1, MON_GENDERLESS, {0, 0, 0, 0, 0, 0}, {31, 31, 31, 31, 31, 31}},
    [BALL_MIDDLE_THIRD]     = {SPECIES_CYNDAQUIL, 5, ITEM_ORAN_BERRY, BALL_POKE, NATURE_DOCILE, 1, MON_GENDERLESS, {0, 0, 0, 0, 0, 0}, {31, 31, 31, 31, 31, 31}},

    [BALL_MIDDLE_SECOND]    = {SPECIES_BULBASAUR, 5, ITEM_ORAN_BERRY, BALL_POKE, NATURE_DOCILE, 1, MON_GENDERLESS, {0, 0, 0, 0, 0, 0}, {31, 31, 31, 31, 31, 31}},
    [BALL_BOTTOM_FIRST]     = {SPECIES_CHARMANDER, 5, ITEM_ORAN_BERRY, BALL_POKE, NATURE_DOCILE, 1, MON_GENDERLESS, {0, 0, 0, 0, 0, 0}, {31, 31, 31, 31, 31, 31}},
    [BALL_BOTTOM_SECOND]    = {SPECIES_SQUIRTLE, 5, ITEM_ORAN_BERRY, BALL_POKE, NATURE_DOCILE, 1, MON_GENDERLESS, {0, 0, 0, 0, 0, 0}, {31, 31, 31, 31, 31, 31}},
};
